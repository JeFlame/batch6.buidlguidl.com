            ...
            <div className="flex justify-center items-center gap-8 flex-col sm:flex-row">
              <div className="flex flex-col py-6 text-center items-center max-w-xs rounded-3xl">
                <div className="flex flex-col bg-base-100 px-6 py-6 text-center items-center max-w-xs rounded-3xl mb-6">
                  ...
                  <p>
                    ...
                    <Link href="https://github.com/" passHref className="link">
                      GitHub
                    </Link>
                  </p>
                </div>
                ...
                <div className="flex flex-col bg-base-100 px-6 py-6 text-center items-center max-w-xs rounded-3xl">
                  ...
                  <p>
                    Contact me via this{" "}
                    <Link href="mailto:hoangvu130301@gmail.com" passHref className="link">
                      email
                    </Link>
                  </p>
                </div>
              ...
              <div className="flex flex-col py-6 text-center items-center max-w-xs rounded-3xl">
                <div className="flex flex-col bg-base-100 px-6 py-6 text-center items-center max-w-xs rounded-3xl mb-6">
                  ...
                  <p>
                    View my profile on{" "}
                    <Link href="https://www.linkedin.com/in/hoang-vu-847288202/" passHref className="link">
                      LinkedIn
                    </Link>
                  </p>
                </div>
                ...
                <div className="flex flex-col bg-base-100 px-6 py-6 text-center items-center max-w-xs rounded-3xl">
                  ...
                  <p>
                    Follow me on{" "}
                    <Link href="https://twitter.com/iaawyalytcl" passHref className="link">
                      Twitter
                    </Link>
                  </p>
                </div>
